							...
							<div class="column_inner">
								<div class="contact_form">
									...
									<form id="contact-form" method="post" action="">
										...
										<div class="column1">
											<div class="column_inner">
												<input type="text" class="requiredField subject" name="email" id="email" value="" placeholder="<?php _e('Subject *', 'qode'); ?>" />
...
jQuery(document).ready(function($){
    $j('form#contact-form').submit(function(){
        ...
        if(!hasError){
			...
			data: {"action":"my_email","recaptcha_challenge_field": challengeField, "recaptcha_response_field": responseField, "name":name, "lastname":lastname,"email":email, "message": message},
