...
<body <?php body_class(); ?>>
	...
	?>
		<script>
			...
			jQuery('header').addClass('single-page-header');
		});
		</script>
	<?php }
		}
                ...
                <?php } ?>
					<div class="header_inner_left">
						...
						<div class="logo_wrapper">
							...
							<div class="q_logo">
								<a href="<?php echo home_url('/'); ?>">
									<img class="normal" src="<?php echo get_stylesheet_directory_uri(). '/img/Ultimate-Bali-Header-Logo.png'; ?>" alt="Logo"/>
									<img class="light" src="<?php echo $logo_image_light; ?>" alt="Logo"/>
									<img class="dark" src="<?php echo $logo_image_dark; ?>" alt="Logo"/>
									<img class="sticky" src="<?php echo $logo_image_sticky; ?>" alt="Logo"/>
									<img class="mobile" src="<?php echo get_stylesheet_directory_uri(). '/img/Ultimate-Bali-Header-Logo.png'; ?>" alt="Logo"/>
