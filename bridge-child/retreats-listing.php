...
$html .= "";
	...
	if ($filter != "yes") {
		...
		if($type == 'masonry_with_space'){
			...
			foreach ($portfolio_categories as $retreat_category) {
				$html .= "<li class='filter' data-filter='.retreat_category_$retreat_category->term_id'><span>$retreat_category->name</span>";
				$args = array(
			...
			$html .= "<div class='filter_outer'>";
			$html .= "<div class='filter_holder retreat_holder'>
					<ul>
			...
			foreach ($portfolio_categories as $retreat_category) {
				$html .= "<li class='filter' data-filter='retreat_category_$retreat_category->term_id'><span". $filter_style .">$retreat_category->name</span>";
				$args = array(
					'child_of' => $retreat_category->term_id
				);
				$html .= '</li>';
	...
	if(isset($_POST['retreat_name'])){
		
		$retreat_name = $_POST['retreat_name'];
