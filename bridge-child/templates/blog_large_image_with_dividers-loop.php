				...
				<div class="post_text">
					<div class="post_text_inner">
						<div class="post_text_holder">
							...
							<div class="blog_column2 Test">
								<h1><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
								<h2 class="post_excerpt"><?php echo get_the_excerpt(); ?></h2>
								<div class="post_info">
				...
				<div class="post_text">
					<div class="post_text_inner">
						<div class="post_text_holder">
							...
							<div class="blog_column2">
								<h3 class="custom-article-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
								<h2 class="post_excerpt"><?php echo get_the_excerpt(); ?></h2>
								<div class="post_info">
									<div class="post_info_left">
										<!--<span class="blog_time"><?php //the_time('H:i'); ?> / </span>-->
