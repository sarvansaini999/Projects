								...
								<div class="contact_form">
									...
									<form id="booking_form" action="" method="POST">
											<div class="two_columns_50_50 clearfix">
												...
												<div class="column1">
													<div class="column_inner">Venue Name:</div>
												</div>
											 
												<div class="column2">
													<div class="column_inner">
														<strong><?php echo $venue_title = $_GET['venue_title']; ?></strong>
													</div>
												</div>
												<br/><br/>
												<div class="column1">
													<div class="column_inner">Programme Name:</div>
												</div>
											 
												<div class="column2">
													<div class="column_inner">
														<strong><?php echo $title = $_GET['title']; ?></strong>
													</div>
												</div>
												<br/><br/>
												...
												<div class="column1">
													<div class="column_inner">
														<input type='text' name='customer_name' id='customer_name' value="<?php echo $name; ?>" size="50" placeholder="Your Full Name *"/>
													</div>
												</div>
											 
												<div class="column2">
													<div class="column_inner">
														<input type='text' name='email' id='email' value="<?php echo $email; ?>" size="50" placeholder="Email Address *"/>
													</div>
												</div>
												...
												<div class="column2">
													<div class="column_inner">
														<input type='text' name='phone' id='phone' value="<?php echo $phone; ?>" size="50" placeholder="Phone Number *"/>
													</div>
												</div>
												
												<div class="column1">
													<div class="column_inner">
														<input type='text' name='arrival_date' id='arrival_date' value="<?php echo $arrival_date; ?>" size="50" class="date-picker" placeholder="Arrival Date *"/>
													</div>
												</div>
											 
												<div class="column2">
													<div class="column_inner">
														<input type='text' name='departure_date' id='departure_date' value="<?php echo $departure_date; ?>" size="50"  class="date-picker" placeholder="Departure Date *"/>
													</div>
												</div>
												...
												<div class="column1">
													<div class="column_inner">
													  ...
													  <?php if(empty($nights)){ ?>
														<option value="">Number Of Night *</option>
													  <?php } ?>
...
<script>
	jQuery(document).ready(function($){	
		...
		$("#submit").click(function(){
			var name,phone,email,country,arrival_date,departure_date,nights,adults,guests,infants,about_us,msg;
