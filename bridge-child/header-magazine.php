...
<body <?php body_class(); ?>>
	<?php if ( is_user_logged_in() ) { $when_logged = "align-bottom"; } ?> 
	<?php
	...
	?>
		...
		jQuery(document).ready(function(){
			...
			jQuery('#magazine-header').removeClass('fixed');
		});
...
<?php if($header_bottom_appearance == "fixed"){ ?>
	...
	<header id="magazine-header" class="<?php echo $header_classes; ?> page_header has_top fixed_top_header <?php echo $when_logged; ?>">
		...
		<?php } ?>
			...
			<div class="header_top_bottom_holder">
					<div class="top_header clearfix <?php echo $when_logged; ?>" <?php echo $header_top_color_per_page; ?> >
						<?php if($header_in_grid){ ?>
							<div class="container">
								<div class="container_inner clearfix">
					...
					<?php } ?>
						<div class="header_inner_center">
							<div class="logo_wrapper" style="height: <?php echo $logo_height/2; ?>px;">
								...
								?>
								<?php 
									$attachment_id = 21431; // attachment ID

									$image_attributes = wp_get_attachment_image_src( $attachment_id ); // returns an array
									//if( $image_attributes ) { 
								?> 
								<div class="q_logo test" style="margin-top: 5px;">
									<a style="height: <?php echo $logo_height/2; ?>px;" href="<?php echo home_url('/'); ?>">
										<img class="normal" src="<?php echo get_stylesheet_directory_uri(). '/img/Ultimate-Bali-Header-Logo-magazine.png'; ?>" alt="Logo"/>
										<img class="light" src="<?php echo $logo_image_light; ?>" alt="Logo"/>
										<img class="dark" src="<?php echo $logo_image_dark; ?>" alt="Logo"/>
										<img class="mobile" src="<?php echo get_stylesheet_directory_uri(). '/img/Ultimate-Bali-Header-Logo-magazine.png'; ?>" alt="Logo"/>
									</a>
								</div>
								<?php //} ?>
							</div>
