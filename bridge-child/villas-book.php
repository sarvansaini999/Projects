...
if (!empty($_POST)) {
	...
	if($error ==false){
		$body='<table width="600px">';
			...
			$body .='<tr>';
				$body .='<td style="vertical-align: top;width: 160px">Villa Name</td>';
			...
			$body .='<tr>';
				$body .='<td style="vertical-align: top;width: 160px">Number of Adults</td>';
				$body .='<td>' . $adults .'</td>';
			$body .='</tr>';
			
			
			$body .='<tr>';
				$body .='<td style="vertical-align: top;width: 160px">Number of Children</td>';
				$body .='<td>' . $children .'</td>';
			$body .='</tr>';
			
			$body .='<tr>';
				$body .='<td style="vertical-align: top;width: 160px">Number of Infants</td>';
				$body .='<td>' . $infants .'</td>';
			$body .='</tr>';
							...
							<div class="column_inner">
								<div class="contact_form">
									...
									<form id="booking_form" action="" method="POST">
												...
												<div class="column1">
													<div class="column_inner">
														<select name="adults" class="requiredField" id="adults">
													  <?php if(empty($adults)){ ?>
												...
												<div class="column2">
													<div class="column_inner">
													  ...
													  <?php } ?>
														<option value="1" <?php if($children=="0") echo 'selected="selected"'; ?> >0</option>
														<option value="1" <?php if($children=="1") echo 'selected="selected"'; ?> >1</option>
														<option value="2" <?php if($children=="2") echo 'selected="selected"'; ?> >2</option>
														<option value="3" <?php if($children=="3") echo 'selected="selected"'; ?> >3</option>
														<option value="4" <?php if($children=="4") echo 'selected="selected"'; ?> >4</option>
														<option value="5" <?php if($children=="5") echo 'selected="selected"'; ?> >5</option>
														<option value="6" <?php if($children=="6") echo 'selected="selected"'; ?> >6</option>
														<option value="7" <?php if($children=="7") echo 'selected="selected"'; ?> >7</option>
														<option value="8" <?php if($children=="8") echo 'selected="selected"'; ?> >8</option>
														<option value="9" <?php if($children=="9") echo 'selected="selected"'; ?> >9</option>
														<option value="10" <?php if($children=="10") echo 'selected="selected"'; ?> >10</option>
													</select>
													</div>
												</div>
												...
												<div class="column2">
													<div class="column_inner">
													  ...
													  <?php if(empty($infants)){ ?>
														<option value="">Number of Infants </option>
													  <?php } ?>
														<option value="1" <?php if($infants=="0") echo 'selected="selected"'; ?> >0</option>
								...
								<div class="contact_info">
									...
									<div class="projects_holder  clearfix portfolio_full_image">
											<?php	
												...
												echo $terms = wp_get_post_terms($post_id, 'category');
												echo $terms = wp_get_post_terms($post_id, 'villa_category');
												echo $bedrooms = get_post_meta($post_id, "bedrooms", true);
												echo $adults = get_post_meta($post_id, "guest", true);
											...
											<div class="relatedcontent">
												<div class="portfolio_description "><h5 class="portfolio_title "> 
													<a href="<?php echo get_permalink ( $post_id ) ?>" target="_self"><?php echo get_the_title( $post_id ); ?></a>
...
<script>
	jQuery(document).ready(function($){	
		...
		$("#submit").click(function(){
			...
			var name,phone,email,country,arrival_date,departure_date,infants,adults,budget,msg;
			...
			if(name=='' ){
				...
				$("#message").show().html('Please Select number of children.');
				return false;
			}else if(infants==''){
				$("#message").show().html('Please Select number of infants.');
				return false;
			}	*/ 
