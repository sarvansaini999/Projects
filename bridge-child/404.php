...
<?php get_header('archive'); ?>
			...
			<div class="title_outer title_without_animation page-not-found" data-height="735">
				<div class="background-fixed title title_size_large  position_center  has_background" style="padding-top:100px;height:635px; background:url('<?php echo get_stylesheet_directory_uri(). '/img/Error-404.jpg'; ?>') !important;background-attachment: fixed !important;background-size: 1920px auto;background-repeat: no-repeat !important;background-position: center 0 !important;">
							...
							<div class="container_inner clearfix">
								<div class="title_subtitle_holder">
									<div class="title_subtitle_holder_inner ">
										<p>The page you are looking for does not exist. It may have been moved, or removed altogether. Perhaps <br /> you can return back to the site’s homepage and see if you can find what you are looking for.</P>
										
									</div>
									<p><a class="qbutton with-shadow" href="<?php echo home_url(); ?>/"><?php if($qode_options_proya['404_backlabel'] != ""): echo $qode_options_proya['404_backlabel']; else: ?> <?php _e('Back to our homepage', 'qode'); ?> <?php endif;?></a></p>
								</div>
							</div>
						</div>
					</div>
