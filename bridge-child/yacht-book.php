...
if (!empty($_POST)) {
	...
	if($error ==false){
		$body='<table width="600px">';
			...
			$body .='<tr>';
				$body .='<td style="vertical-align: top;width: 160px">Yacht Name</td>';
				$body .='<td><a href="'.$post_url.'">' . $post_title .'</a></td>';
			$body .='</tr>';
			if($programme_name != ''){
				$body .='<tr>';
					$body .='<td style="vertical-align: top;width: 160px">Package Name</td>';
							...
							<div class="column_inner">
								<div class="contact_form">
									...
									<form id="booking_form" action="" method="POST">
												...
												<div class="column1">
													<div class="column_inner">
													<input type='hidden' name='programme_name' id='programme_name' value="<?php echo $title = $_POST['title']; ?>" class="placeholder" placeholder="Package Name *"/>
													<input type='text' value="<?php echo $title = $_POST['title']; ?>" class="placeholder" placeholder="Package Name *"/>
								...
								<div class="contact_info">
									...
									<div class="projects_holder  clearfix portfolio_full_image">
											<?php	
												...
												echo $guests = get_post_meta($post_id, "guest", true);
